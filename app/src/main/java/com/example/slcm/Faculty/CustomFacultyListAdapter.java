...
public class CustomFacultyListAdapter extends BaseAdapter {
    private Context context;
    private String[] rollNumbers;

    private boolean[] itemStates; // Track the state of each item

    public CustomFacultyListAdapter(Context context, String[] rollNumbers) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.activity_student_attendance_list_item, parent, false);
        }
